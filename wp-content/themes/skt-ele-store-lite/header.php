<?php 
/**
 * The Header for SKT Ele Store Lite
 *
...
.has_trans_header .header_wrap{padding-top: 24px;}
#topmenu ul li.current-menu-item > a:before{content: ""; border-top: solid 10px <?php echo $complete['slider_wave_color2'] ?>; border-left: solid 10px transparent; border-right: solid 10px transparent; position: absolute; top: 0; left: 0; right: 0; margin: 0 auto; width: 0;}
}
</style>
<?php } ?>
</head>
...
<body <?php body_class();?>>
<!--HEADER-->
<?php if(is_front_page()){ ?> <div class="skt-header-wave"></div><?php } ?>
