<?php
 /**
 * The CORE functions for SKT Ele Store Lite
 *
...
function complete_widgets_init(){
	...
	register_sidebar(array(
	'name'          => __('WooCommerce Pages Sidebar', 'complete'),
	'id'            => 'sidebar-woo',
	'description'   => __('When you assign widgets to this area, it will be displayed on all woocommerce pages.', 'complete'),
	'before_widget' => '<div id="%1$s" class="widget %2$s" data-widget-id="%1$s"><div class="widget_wrap">'.$editbutton,
	'after_widget'  => '<span class="widget_corner"></span></div></div>',
	'before_title'  => '<h3 class="widgettitle">',
	'after_title'   => '</h3>'
