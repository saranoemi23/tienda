<?php
/**
 * The CSS/JS ENQUEUE functions for SKT Ele Store Lite
 *
...
function complete_css_js() { 
	if ( !is_admin() ) {
		...
		wp_enqueue_script('complete_count',get_template_directory_uri().'/assets/js/counterup.min.js', array('jquery'), true);
		wp_enqueue_script('complete_verticalslider',get_template_directory_uri().'/assets/js/verticalslider.js', array('jquery'), true);
