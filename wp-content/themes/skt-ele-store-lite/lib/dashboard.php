	...
	class SKT_Complete_Notify_Admin {
		...
		public function admin_notices() {
			...
			if (!is_plugin_active('elementor/elementor.php')) {
				echo '<div class="error"><p>'.esc_html('Elementor Page Builder plugin is a must required plugin for this theme').'</p></div>';
				}
  ...
  <div class="notice-content">
    ...
    <h2>
      <?php
							...
							printf( esc_html__( 'Thank you for installing %s.', 'skt-complete' ), '<strong>SKT Ele Store Lite</strong>' );
							?>
    </h2>
    <p> <a href="<?php echo esc_url( admin_url( 'themes.php?page=theme-options' ) ); ?>" class="button button-primary">
      <?php
								/* translators: %s: Theme name */
								printf( esc_html__( 'Get started with %s', 'skt-complete' ), 'SKT Ele Store Lite' );
								?>
      </a> </p>
    <?php else : ?>
  ...
  <div class="notice-content">
    ...
    <p>
      <?php
							...
							printf( esc_html__( 'To take full advantage of all the features this theme has to offer, please install and activate FIRST the %s plugin.', 'skt-complete' ), '<strong>Elementor Page Builder</strong> and then followed by <strong>Theme Demo Import</strong>' );
							?>
    </p>
    <?php } ?>
    <?php if (!is_plugin_active('theme-demo-import/theme-demo-import.php') && !is_plugin_active('theme-demo-import/theme-demo-import.php')) {?>
    <p>
      <?php 
						...
						$sktbuilder = array('elementor','theme-demo-import');
						$sktbuilder_php = array('elementor.php','theme-demo-import.php');
						$sktbuilder_title = array('Elementor Page Builder','Theme Demo Import');
